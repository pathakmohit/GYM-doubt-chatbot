...
# Specify the path for saving the files
save_path = r'D:\project101\customer service(gym)'

# Load intents.json file
with open('D:\project101\customer service(gym)\intents.json ', 'r') as file:
...
# Save words and classes using pickle to the specified path
pickle.dump(words, open(os.path.join(save_path, "words.pkl"), "wb"))
